...
public class ConverterMain {
    ...
    public static void main(String[] args) {
        ...
        if (cmd.hasOption('e')) {
            if (cmd.getOptionValue('e').equals("xtr")) {
            ...
            logger.severe("You must input the export type: excel to resource (=xtr) or resource to excel (rtx)");
            help();
        }
    }
    ...
    private static void help() {
        ...
        System.out.println("\n\n******************************************************************************");
        System.out.println("\nFormat of the Configuration file for XLS-TO-RES");
        System.out.println("[");
        System.out.println("     {");
        ...
        System.out.println("java -jar xlsToResource.jar -e xtr -c config-xls-to-res.json -a string.xml -i sample.strings");

        System.out.println("\n\n******************************************************************************");
        System.out.println("\nFormat of the Configuration file for RES-TO-XLS");
        System.out.println("[");
        System.out.println("     {");
        ...
        System.out.println("");
        System.out.println("Example of how to use:");
        System.out.println("java -jar xlsToResource.jar -e xtr -c config-res-to-xls.json");
